...
- [ ] **10. Vet.toString()** — `src/main/java/org/springframework/samples/petclinic/vet/Vet.java`
...
- [ ] **11. i18n keys** — `src/main/resources/messages/messages.properties` and all locale variants
